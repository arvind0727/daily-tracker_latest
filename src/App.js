          ...
          <div style={{ display: 'grid', gridTemplateColumns: window.innerWidth > 768 ? '1.5fr 1fr' : '1fr', gap: '20px' }}>
            <div style={{ background: 'rgba(20,20,20,0.6)', border: '1px solid rgba(255,255,255,0.15)', borderRadius: '20px', padding: 'clamp(15px, 3vw, 20px)', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
              <div>
                ...
                <input type="text" value={name} onChange={e => setName(e.target.value)} placeholder="Meal Name" style={{ width: '-webkit-fill-available', padding: '12px', background: 'rgba(255,255,255,0.05)', border: '1px solid rgba(255,255,255,0.1)', borderRadius: '10px', color: '#fff', marginBottom: '15px', outline: 'none', fontSize: 'clamp(0.8rem, 1.5vw, 1rem)' }} />
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
              <div style={{ background: 'rgba(20,20,20,0.6)', border: '1px solid rgba(255,255,255,0.15)', borderRadius: '20px', padding: 'clamp(15px, 3vw, 20px)' }}>
                ...
                <input type="text" value={burnAct} onChange={e => setBurnAct(e.target.value)} placeholder="Activity" style={{ width: '-webkit-fill-available', padding: '12px', background: 'rgba(255,255,255,0.05)', border: '1px solid rgba(255,255,255,0.1)', borderRadius: '10px', color: '#fff', marginBottom: '10px', outline: 'none', fontSize: 'clamp(0.8rem, 1.5vw, 1rem)' }} />
                <input type="number" value={burnCal} onChange={e => setBurnCal(e.target.value)} placeholder="Calories" style={{ width: '-webkit-fill-available', padding: '12px', background: 'rgba(255,255,255,0.05)', border: '1px solid rgba(255,255,255,0.1)', borderRadius: '10px', color: '#fff', marginBottom: '10px', outline: 'none', fontSize: 'clamp(0.8rem, 1.5vw, 1rem)' }} />
              ...
              <div style={{ background: 'rgba(20,20,20,0.6)', border: '1px solid rgba(255,255,255,0.15)', borderRadius: '20px', padding: 'clamp(15px, 3vw, 20px)' }}>
                ...
                <input type="text" value={expItem} onChange={e => setExpItem(e.target.value)} placeholder="Item" style={{ width: '-webkit-fill-available', padding: '12px', background: 'rgba(255,255,255,0.05)', border: '1px solid rgba(255,255,255,0.1)', borderRadius: '10px', color: '#fff', marginBottom: '10px', outline: 'none', fontSize: 'clamp(0.8rem, 1.5vw, 1rem)' }} />
                <input type="number" value={expAmt} onChange={e => setExpAmt(e.target.value)} placeholder="Amount" style={{ width: '-webkit-fill-available', padding: '12px', background: 'rgba(255,255,255,0.05)', border: '1px solid rgba(255,255,255,0.1)', borderRadius: '10px', color: '#fff', marginBottom: '10px', outline: 'none', fontSize: 'clamp(0.8rem, 1.5vw, 1rem)' }} />
                <input type="text" value={expDet} onChange={e => setExpDet(e.target.value)} placeholder="Details" style={{ width: '-webkit-fill-available', padding: '12px', background: 'rgba(255,255,255,0.05)', border: '1px solid rgba(255,255,255,0.1)', borderRadius: '10px', color: '#fff', marginBottom: '10px', outline: 'none', fontSize: 'clamp(0.8rem, 1.5vw, 1rem)' }} />
